...
// });
// Route::get('/', function () {
//     return 'selamat belajar laravel, yang semangat ya kakak';
// });
Route::get('biodata', function () {
    return 'Nama : Rakhma Aksata Ariela <br> NIM : 3.34.19.1.20 <br> Alamat : Wonosobo <br> Hobi : Memasak';
});
...
Route::get('biodata2', function () {
    return view('biodata2'); //bikin di view
});
...
Route::get('home', function () {
    return view('home'); //bikin di view
});

Route::get('data_peminjam', function () {
    return view('peminjams/data_peminjam'); //bikin di view
});

// Route::get('lihat_data_peminjam', function () {
//     $peminjam = ['Tata', 'Rizki', 'Aulia', 'Irma'];
//     return view('peminjams/lihat_data_peminjam', compact('peminjam')); //bikin di view
// });
...
Route::get('/peminjams/search', [PeminjamController::class, 'search'])->name('peminjams.search');
...
Route::get('coba_collection', [PeminjamController::class, 'Coba_Collection']);
